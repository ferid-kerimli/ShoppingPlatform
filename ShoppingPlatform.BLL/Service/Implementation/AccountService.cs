...
public class AccountService : IAccountService
{
    ...
    public AccountService(SignInManager<AppUser> signInManager, UserManager<AppUser> userManager, ITokenService tokenService, IMapper mapper, IFluentEmail fluentEmail, IVerificationService verificationService)
    {
